...
func (db *appdbimpl) GetUserProfileByID(studentId int, firstName string, lastName string, email string, repoURL string, publicKey string, privateKey string) error {
	tx, err := db.c.Begin()
	if err != nil {
		return err
	}
